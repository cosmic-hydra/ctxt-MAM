...
import { postEntry, readFeed, clearFeed, countEntries, listContextNamespaces, digestChannel, listOpenQuestions, isSharedContextEnabled, CONTEXT_KINDS, DEFAULT_READ_LIMIT, MAX_READ_LIMIT, } from '../lib/shared-context.js';
describe('Shared Context Feed', () => {
    ...
    describe('postEntry / readFeed', () => {
        ...
        it('records optional tags and refs', () => {
            ...
            const second = postEntry('ns', 'architect', 'answer', 'JWT — see decision', { tags: ['auth', 'security'], refs: [first.id] });
    ...
    describe('digestChannel', () => {
        ...
        it('records firstAt and lastAt timestamps', () => {
            ...
            expect(new Date(digest.lastAt).getTime()).toBeGreaterThanOrEqual(new Date(digest.firstAt).getTime());
        });
    });
    // =========================================================================
    // listOpenQuestions
...
//# sourceMappingURL=shared-context.test.js.map